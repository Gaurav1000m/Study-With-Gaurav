...
export function DonateClient() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white font-sans">
      ...
      <main id="main-content" className="flex-1 py-4 sm:py-16 pb-24 md:pb-12 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-3 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-12 items-start">
            ...
            {/* Left Column: Mission & Info (Desktop Col 7, Mobile Order 2) */}
            <div className="order-2 lg:order-1 lg:col-span-7 space-y-4 sm:space-y-8">
              ...
              <div className="space-y-2 sm:space-y-4">
                <h1 className="text-xl sm:text-4xl lg:text-5xl font-extrabold text-slate-900 tracking-tight leading-[1.15]">
              ...
              <div className="space-y-3 sm:space-y-4 bg-white p-4 sm:p-7 rounded-2xl border border-slate-200/90 shadow-2xs">
                ...
                <ul className="space-y-3.5 sm:space-y-5">
                  <li className="flex items-start gap-3">
                    <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-blue-50 flex items-center justify-center shrink-0 border border-blue-100 shadow-2xs mt-0.5">
                      <Globe className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600" />
                    </div>
                    <div>
                      <h3 className="font-bold text-slate-900 text-xs sm:text-base">Domain & Fast Hosting</h3>
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-amber-50 flex items-center justify-center shrink-0 border border-amber-100 shadow-2xs mt-0.5">
                      <Key className="w-4 h-4 sm:w-5 sm:h-5 text-amber-600" />
                    </div>
                    <div>
                      <h3 className="font-bold text-slate-900 text-xs sm:text-base">APIs & Content Updates</h3>
                      <p className="text-xs sm:text-sm text-slate-500 mt-0.5 leading-relaxed">
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-emerald-50 flex items-center justify-center shrink-0 border border-emerald-100 shadow-2xs mt-0.5">
                      <Coffee className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-600" />
                    </div>
                    <div>
                      <h3 className="font-bold text-slate-900 text-xs sm:text-base">Student Developer Support</h3>
                      <p className="text-xs sm:text-sm text-slate-500 mt-0.5 leading-relaxed">
            ...
            {/* Right Column: Donation Card (Desktop Col 5, Mobile Order 1 - Prioritized) */}
            <div className="order-1 lg:order-2 lg:col-span-5 space-y-4 w-full">
